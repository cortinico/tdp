...
La prima classe che presentiamo \`e la classe \textsf{KeyEventManager}, che implementa l'interfaccia \textsf{java.swing.event.KeyListner}, \`e si occupa di raccogliere gli eventi da tastiera dell'utente e li trasforma in comandi.
...
\begin{figure}[h]
\centering
\includegraphics[width=12cm]{Command.pdf}
